...
1. Under `Scopes`, select `Custom defined` and choose the following scopes:
   ...
   - **Identity**: Read (required for migration tools)
    ...
    <img width="600" alt="Show all scopes link at the bottom of the token scopes view" src="https://github.com/X-14537kuldeepsaini/KD_skills-migrate-ado-repository_Dummy/blob/main/.github/images/show-all-scopes-link.png?raw=true" />
